...
**结果 (端到端, 4 threads, pp256, warmup=5, 3-run avg)**：
| 指标 | 尝试 21 (回退) | 尝试 22 (修复) | 变化 |
|------|----------------|----------------|------|
| prefill_tps | ~150 | **~152** | +1% |
| decode_tps | ~30 | ~30.4 | 持平 |
...
| + CONCAT/TILE bulk memcpy (bug) | ~162.0 | ~30.7 | 1243 |
| + SILU/ADD/MUL NEON | ~167.5 | ~31.4 | 1243 |
| + CONCAT/TILE 修复正确性 | **~152.0** | **~30.4** | 1243 |
...
差距：prefill **1.3-1.7x**, decode **1.1-1.3x**
