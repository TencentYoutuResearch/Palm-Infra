...
//
// The engine picks a backend at load time based on target / config. Concrete
// implementations live under backends/; this contract is shared by CPU,
// Metal, CUDA, and future backends.
// ---------------------------------------------------------------------------
